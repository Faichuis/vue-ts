    ...
    setTopPlace() {
        ...
        if (scrollTop > this.moduleHeight) {
            switch (this.currentIndex) {
                case 0:
                    t0 = scrollTop / (this.moduleHeight * 3);
                    t1 = t2 = t0;
                    break;
                case 1:
                    t1 = (scrollTop - this.moduleHeight) / (this.moduleHeight * 3);
                    t0 = t1 + 1;
                    t2 = t1;
                    break;
                case 2:
                    t2 = (scrollTop - this.moduleHeight * 2) / (this.moduleHeight * 3);
                    t0 = t1 = t2 + 1;
            }
        }
        this.times0 = t0;
        this.times1 = t1;
        this.times2 = t2;
        this.topPlaceholderHeight = (scrollTop / this.moduleHeight) * this.moduleHeight;
        this.setTableData();
    };
